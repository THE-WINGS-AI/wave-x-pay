...
class SignupOtpVerificationView extends GetView<SignupOtpVerificationController> {
  final SignupOtpVerificationController signupOtpVerificationController = Get.put(SignupOtpVerificationController());
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            ...
            OrangeButton(label: "Continue",horizontalPadding: 5, onTap: () => signupOtpVerificationController.verifyOtp()),
            ...
            Row(
              ...
              children: [
                ...
                TextButton.icon(
                  onPressed: signupOtpVerificationController.resendOtp,
    ...
    return ClipRRect(
      ...
      child: BackdropFilter(
        ...
        child: Container(
          ...
          child: TextField(
            controller: signupOtpVerificationController.controllers[index],
            focusNode: signupOtpVerificationController.focusNodes[index],
            onChanged: (v) => signupOtpVerificationController.onOtpChanged(v, index),
            textAlign: TextAlign.center,
