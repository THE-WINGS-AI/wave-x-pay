...
class ConfirmationSigninView extends GetView<ConfirmationSigninController> {
    final ConfirmationSigninController confirmationSigninController = Get.put(ConfirmationSigninController());
   ConfirmationSigninView({super.key});
  @override
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              OrangeButton(label: "All right", horizontalPadding: 5, onTap: () => confirmationSigninController.navigateToNext()),
